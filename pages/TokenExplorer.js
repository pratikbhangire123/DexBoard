                    ...
                    <div className={styles.tokenExplorerHeaderRight}>
                        <div>
                            ...
                            <div>({item?.contract_address?.slice(0, 10) + '.....'})
                                <svg onClick={() => { navigator.clipboard.writeText(item?.contract_address), alert('Copied!') }} xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#bebebe" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
